...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _register() async {
    ...
    if (_passwordController.text != _confirmPasswordController.text) {
      showAppSnackBar(context, const SnackBar(content: Text("Mật khẩu xác nhận không khớp")));
      return;
    }

    if (!_termsAccepted) {
      showAppSnackBar(context, const SnackBar(content: Text("Bạn cần đồng ý với điều khoản dịch vụ")));
      return;
    }
    ...
    try {
      ...
      if (mounted) {
        showAppSnackBar(context, const SnackBar(content: Text("Đăng ký thành công! Hãy đăng nhập.")));
      ...
      if (mounted) {
        showAppSnackBar(context, SnackBar(content: Text("Lỗi đăng ký: ${e.toString()}")));
      }
    } finally {
